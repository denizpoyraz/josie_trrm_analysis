...
pre=''
if bool_sm_vh: pre = '_HVbeta_sm_hv'
df96c = pd.read_csv(f"/home/poyraden/Analysis/JOSIEfiles/Proccessed/Josie9602_deconv_2023paper_sm_hv.csv", low_memory=False)
...
df96c['Ifast_minib0_deconv_sm10'] = df96c['Ifast_deconv'].rolling(window=5, center=True).mean()
...
if bool_sm_vh:
    ...
    df96c['Ifast_minib0_deconv_sm10'] = df96c['Ifast_deconv']
