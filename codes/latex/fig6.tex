...
%          \centering
        \subfloat[]{%
            \includegraphics[width=.63\linewidth]{png/scatter_fig6_0910_SPC1010_pressure}%

%            \label{subfig:a}%
        }
        \hspace{-9mm}
        \subfloat[]{%
            \includegraphics[width=.63\linewidth]{png/scatter_fig6_0910_EN0505_pressure}%
            \label{subfig:b}%
        }
        \vspace{-1mm}
%          \centering
        \subfloat[]{%
            \includegraphics[width=.63\linewidth]{png/scatter_fig6_0910_SPC0505_pressure}%
            \label{subfig:c}%
        }
        \hspace{-9mm}
        \subfloat[]{%
            \includegraphics[width=.63\linewidth]{png/scatter_fig6_0910_EN1010_pressure}%
            \label{subfig:d}%
        }
%        \caption{Caption}
        \label{fig:fig}
