...
# plt.savefig(f'/home/poyraden/Analysis/JosieAnalysis/Plots/Plots_2023_final/v7/png/fig10_one_{year}')

plt.savefig(f'/home/poyraden/Analysis/JosieAnalysis/Plots/Plots_2023_final/v7/png/sup9_two_{year}')
plt.show()
