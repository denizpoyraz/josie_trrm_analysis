...
dffi['ratio_2'] = -dffi['iB0'] / dffi['IM'] * 100
dffi['ratio_2ib1'] = -dffi['iB1'] / dffi['IM'] * 100
dffi['ratio_3'] = -dffi['Islow_conv'] / dffi['IM'] * 100
dffi['ratio_6'] = (dffi['Ifast_minib0_deconv'] - dffi['Ifast_minib0']) / dffi['IM'] * 100
dffi['ratio_7'] = (dffi['Cpf_jma'] - 1) * 100
dffi['ratio_7kom'] = (dffi['Cpf_kom'] - 1) * 100
dffi['ratio_con'] = (1 / dffi['etac'] - 1) * 100
dffi['ratio_8'] = dffi['ratio_2'] + dffi['ratio_3'] + dffi['ratio_6'] + dffi['ratio_7'] + dffi['ratio_con']
dffi['ratio_8kom'] = dffi['ratio_2ib1'] + dffi['ratio_7kom']
...
dfj = prof[j]
komj = kom_label[j]
eta = 1 + a_smhv[j]/100 + b_smhv[j]/100* np.log10(dfj['Pair'])
...
dffj['ratio_2'] = -dffj['iB0'] / dffj['IM'] * 100
dffj['ratio_2ib1'] = -dffj['iB1'] / dffj['IM'] * 100
dffj['ratio_3'] = -dffj['Islow_conv'] / dffj['IM'] * 100
dffj['ratio_6'] = (dffj['Ifast_minib0_deconv'] - dffj['Ifast_minib0']) / dffj['IM'] * 100
dffj['ratio_7'] = (dffj['Cpf_jma'] - 1) * 100
dffj['ratio_7kom'] = (dffj['Cpf_kom'] - 1) * 100
dffj['ratio_con'] = (1 / dffj['etac'] - 1) * 100
dffj['ratio_8'] = dffj['ratio_2'] + dffj['ratio_3'] + dffj['ratio_6'] + dffj['ratio_7'] + dffj['ratio_con']
dffj['ratio_8kom'] = dffj['ratio_2ib1'] + dffj['ratio_7kom']
...
xptitle = 'O3 partial pressure [mPa]'
ytitle = 'Pressure [hPa]'
xptitle2 = 'O3 [mPa]'
...
gs = gridspec.GridSpec(1, 4, width_ratios=[1.6, 2, 2,2])
...
ax.legend(loc='best', frameon=True, fontsize=size_legend, markerscale=1, handletextpad=0.1, framealpha=0.65,handlelength=1)
plt.text(1.5,7, one,  fontsize=size_title)
...
# plt.plot(dffi['ratio_2'], dffi['Pair'], marker='o', label=r'I$_{B0}$/I$_M$', markersize=0.5, linewidth=4, color=cbl[1])
# plt.plot(dffi['ratio_3'], dffi['Pair'], marker='o', label=r'I$_S$/I$_M$', markersize=0.5, linewidth=3, color=cbl[2])
# plt.plot(dffi['ratio_6'], dffi['Pair'], marker='o', label=r'(I$_{F,D,S}$ - I$_F$)/I$_M$', markersize=0.5, linewidth=4,
#          color=cbl[3])
# plt.plot(dffi['ratio_7'], dffi['Pair'], marker='o', label=r'(1/JMA - 1)', markersize=0.5, linewidth=4, color=cbl[4])
# plt.plot(dffi['ratio_8'], dffi['Pair'], marker='o', label=r'Total', markersize=0.5, linewidth=4, color=cbl[0])
if bool_trc:
    if bool_extra: ex = 'TRCC'
    plt.plot(dffi['ratio_2'], dffi['Pair'], marker='o', label=r'I$_{B0}$/I$_M$', markersize=0.5, linewidth=4, color=cbl[1])
    plt.plot(dffi['ratio_3'], dffi['Pair'], marker='o', label=r'I$_S$/I$_M$', markersize=0.5, linewidth=5, color=cbl[2])
    plt.plot(dffi['ratio_6'], dffi['Pair'], marker='o', label=r'(I$_{F,D,S}$ - I$_F$)/I$_M$', markersize=0.5, linewidth=4,
             color=cbl[3])
    plt.plot(dffi['ratio_con'], dffi['Pair'], marker='o', label=r'$(1/\eta_{C}(P)-1)$', markersize=0.5, linewidth=4,
             color=cbl[5])
    plt.plot(dffi['ratio_7'], dffi['Pair'], marker='o', label=r'(1/JMA - 1)', markersize=0.5, linewidth=4, color=cbl[4])
    plt.plot(dffi['ratio_8'], dffi['Pair'], marker='o', label=f'Total {ex}', markersize=0.5, linewidth=4, color=cbl[0])

if bool_conventional:
    if bool_extra: ex = 'Conventional'
    plt.plot(dffi['ratio_2ib1'], dffi['Pair'], linestyle="-.", label=r'I$_{B1}$/I$_M$', markersize=0.5, linewidth=4,
             color=cbl[1])
    plt.plot(dffi['ratio_7kom'], dffi['Pair'], linestyle="-.", label=f'(1/{komi} - 1)', markersize=0.5, linewidth=4,
             color=cbl[4])
    plt.plot(dffi['ratio_8kom'], dffi['Pair'], linestyle="-.", label=f'Total {ex}', markersize=0.5, linewidth=4,
             color=cbl[0])

plt.text(-23,7, two,  fontsize=size_title)
ax0.axvline(x=0, color='grey', linestyle='--', linewidth=3)

ax0.legend(loc='lower right', frameon=True, fontsize=size_legend, markerscale=1, handletextpad=0.1, framealpha=0.65,handlelength=1)
...
# plt.plot(dffj['ratio_2'], dffj['Pair'], marker='o', label=r'I$_{B0}$/I$_M$', markersize=0.5, linewidth=4, color=cbl[1])
# plt.plot(dffj['ratio_3'], dffj['Pair'], marker='o', label=r'I$_S$/I$_M$', markersize=0.5, linewidth=3, color=cbl[2])
# plt.plot(dffj['ratio_6'], dffj['Pair'], marker='o', label=r'(I$_{F,D,S}$ - I$_F$)/I$_M$', markersize=0.5, linewidth=4,
#          color=cbl[3])
# plt.plot(dffj['ratio_7'], dffj['Pair'], marker='o', label=r'(1/JMA - 1)', markersize=0.5, linewidth=4, color=cbl[4])
# plt.plot(dffj['ratio_8'], dffj['Pair'], marker='o', label=r'Total', markersize=0.5, linewidth=4, color=cbl[0])
if bool_trc:
    if bool_extra: ex = 'TRCC'
    plt.plot(dffj['ratio_2'], dffj['Pair'], marker='o', label=r'I$_{B0}$/I$_M$', markersize=0.5, linewidth=4, color=cbl[1])
    plt.plot(dffj['ratio_3'], dffj['Pair'], marker='o', label=r'I$_S$/I$_M$', markersize=0.5, linewidth=5, color=cbl[2])
    plt.plot(dffj['ratio_6'], dffj['Pair'], marker='o', label=r'(I$_{F,D,S}$ - I$_F$)/I$_M$', markersize=0.5, linewidth=4,
             color=cbl[3])
    plt.plot(dffj['ratio_con'], dffj['Pair'], marker='o', label=r'$(1/\eta_{C}(P)-1)$', markersize=0.5, linewidth=4,
             color=cbl[5])
    plt.plot(dffj['ratio_7'], dffj['Pair'], marker='o', label=r'(1/JMA - 1)', markersize=0.5, linewidth=4, color=cbl[4])
    plt.plot(dffj['ratio_8'], dffj['Pair'], marker='o', label=f'Total {ex}', markersize=0.5, linewidth=4, color=cbl[0])

if bool_conventional:

    if bool_extra: ex = 'Conventional'
    plt.plot(dffj['ratio_2ib1'], dffj['Pair'], linestyle="-.", label=r'I$_{B1}$/I$_M$', markersize=0.5, linewidth=4,
             color=cbl[1])
    plt.plot(dffj['ratio_7kom'], dffj['Pair'], linestyle="-.", label=f'(1/{komi} - 1)', markersize=0.5, linewidth=4,
             color=cbl[4])
    plt.plot(dffj['ratio_8kom'], dffj['Pair'], linestyle="-.", label=f'Total {ex}', markersize=0.5, linewidth=4,
             color=cbl[0])


plt.text(-23,7, three,  fontsize=size_title)
ax1.axvline(x=0, color='grey', linestyle='--', linewidth=3)

ax1.legend(loc='lower right', frameon=True, fontsize=size_legend, markerscale=1, handletextpad=0.1, framealpha=0.65,handlelength=1)
...
# plt.plot(dffj['ratio_7'], dffj['Pair'], marker='o', label=r'(1/JMA - 1)', markersize=0.5, linewidth=4, color=cbl[4])
# plt.plot(dffj['ratio_8'], dffj['Pair'], marker='o', label=r'Total', markersize=0.5, linewidth=4, color=cbl[0])
bool_conventional = True

if bool_conventional:
    if bool_extra: ex = 'Conventional'
    if year == '0910':
        print('title2', title2, j)
        # i = 4
        # j = 0
        # i=3
        # j=1
        ...
        komj = komi
        title2 = title1
        ax2.set_title(title2, fontsize=size_title)
        plt.plot(dffj['ratio_2ib1'], dffj['Pair'], linestyle="-.", label=r'I$_{B1}$/I$_M$', markersize=0.5, linewidth=4,
                 color=cbl[1])
        plt.plot(dffj['ratio_7kom'], dffj['Pair'], linestyle="-.", label=f'(1/{komj} - 1)', markersize=0.5, linewidth=4,
                 color=cbl[4])
        plt.plot(dffj['ratio_8kom'], dffj['Pair'], linestyle="-.", label=f'Total {ex}', markersize=0.5, linewidth=4,
                 color=cbl[0])
    if year == '2017':

        # ax2.set_title(title1, fontsize=size_title)
        # plt.plot(dffi['ratio_2ib1'], dffi['Pair'], linestyle="-.", label=r'I$_{B1}$/I$_M$', markersize=0.5, linewidth=4,
        #          color=cbl[1])
        # plt.plot(dffi['ratio_7kom'], dffi['Pair'], linestyle="-.", label=f'(1/{komi} - 1)', markersize=0.5, linewidth=4,
        #          color=cbl[4])
...
plt.text(-23,7, four,  fontsize=size_title)

ax2.legend(loc='lower right', frameon=True, fontsize=size_legend, markerscale=1, handletextpad=0.1, framealpha=0.65,handlelength=1)

ax2.axvline(x=0, color='grey', linestyle='--', linewidth=3)

# plt.savefig(f'/home/poyraden/Analysis/JosieAnalysis/Plots/Plots_2023_final/v7/png/fig10_two_extra_{year}')

plt.savefig(f'/home/poyraden/Analysis/JosieAnalysis/Plots/Plots_2023_final/v7/png/sup9_two_extra_{year}')
plt.show()
