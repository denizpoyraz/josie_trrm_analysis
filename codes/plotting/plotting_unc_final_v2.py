...
ax0.legend(loc='lower right', frameon=True, fontsize=size_legend, markerscale=1, handletextpad=0.1, framealpha=0.65)
...
ax1.legend(loc='lower right', frameon=True, fontsize=size_legend, markerscale=1, handletextpad=0.1, framealpha=0.65)
# plt.savefig(f'/home/poyraden/Analysis/JosieAnalysis/Plots/Plots_2023_final/v5/Total_Unc/fig10_two_{year}')

plt.savefig(f'/home/poyraden/Analysis/JosieAnalysis/Plots/Plots_2023_final/v5/Total_Unc/sup8_two_{year}')
plt.show()
####unc plots
# if not bool_gs:
