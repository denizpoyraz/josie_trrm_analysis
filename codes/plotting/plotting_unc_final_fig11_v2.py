...
gs = gridspec.GridSpec(1, 3, width_ratios=[1.6, 2.2, 2.2])
...
plt.plot(dffi['d_im_bkg_trm'] * 100, dffi['Pair'], color=cbl[1], label=r'Current I$_F$',
         linewidth=4)
plt.plot(dffi['d_pfe_hum_trrm'] * 100, dffi['Pair'], color=cbl[2], label=r'Pump eff.$&$ flow rate',
         linewidth=3)
plt.plot(dffi['d_eta_c_trm'] * 100, dffi['Pair'], color=cbl[3], label=f'Conversion eff.',
         linewidth=4)
plt.plot(dffi['d_eta_a'] * 100, dffi['Pair'], color=cbl[4], label=f'Absorption eff', linewidth=4)
plt.plot(dffi['d_tpump'] * 100, dffi['Pair'], color=cbl[5], label=f'Pump temp.', linewidth=4)
plt.plot(dffi['tota_unc_trm'] * 100, dffi['Pair'], color=cbl[0], label=f'Total TRCC  ', linewidth=4)
...
plt.text(10,900, two,  fontsize=size_title)

ax0.legend(loc='lower left', frameon=True, fontsize=size_legend, markerscale=1, handletextpad=0.1, framealpha=0.65,
           handlelength=1.5)
...
# plt.legend()
plt.xlim([0.2, 20])
# ax1.xaxis.set_major_formatter(ScalarFormatter('%0.0f'))
...
plt.xlabel('Rel. uncertainity [%]', fontsize=size_label)
plt.plot(dffj['d_im_bkg_trm'] * 100, dffj['Pair'], color=cbl[1], label=f'Current I$_F$',
         linewidth=4)
plt.plot(dffj['d_pfe_hum_trrm'] * 100, dffj['Pair'], color=cbl[2], label=f'Pump eff.$&$ flow rate',
         linewidth=3)
plt.plot(dffj['d_eta_c_trm'] * 100, dffj['Pair'], color=cbl[3], label=f'Conversion eff.',
         linewidth=4)
plt.plot(dffj['d_eta_a'] * 100, dffj['Pair'], color=cbl[4], label=f'Absorption eff.', linewidth=4)
plt.plot(dffj['d_tpump'] * 100, dffj['Pair'], color=cbl[5], label=f'Pump temp.', linewidth=4)
plt.plot(dffj['tota_unc_trm'] * 100, dffj['Pair'], color=cbl[0], label=f'Total TRCC  ', linewidth=4)
plt.plot(dffj['tota_unc'] * 100, dffj['Pair'], color=cbl[0], label=f'Total Conventional', linewidth=4, linestyle="-.")
plt.text(12,900, three,  fontsize=size_title)

ax1.legend(loc='lower left', frameon=True, fontsize=size_legend, markerscale=1, handletextpad=0.1, framealpha=0.65,
           handlelength=1.5)
# plt.savefig(f'/home/poyraden/Analysis/JosieAnalysis/Plots/Plots_2023_final/v6/Total_Unc/fig11_two_{year}')

plt.savefig(f'/home/poyraden/Analysis/JosieAnalysis/Plots/Plots_2023_final/v6/Total_Unc/sup10_two_{year}')
plt.show()
