...
df1 = pd.read_csv("/home/poyraden/Analysis/JOSIEfiles/Proccessed/"
                  "Josie0910_Deconv_preparationadded_simulation_2023paper_HVbeta_sm_hv.csv",low_memory=False)
df1 = df1[df1.ADX ==0]
...
df2 = pd.read_csv('/home/poyraden/Analysis/JOSIEfiles/Proccessed/Josie0910_deconv_2023_decay_added_147-149_sm_hv_HVbeta_noib0.csv')
df2 = df2[df2.ADX ==0]
...
df1c = df1[['Sim','Team', 'iB0', 'iB1', 'iB2', 'ENSCI', 'Sol', 'ADX','Buf','PO3','PO3_OPM', 'Tsim','Pair',
            ...
            'Ifast_minib0_deconv_ib1_decay','Ifast_minib0', 'Ifast_minib0_ib1_decay', 'Islow_conv','Ifast_deconv_ib1_decay',
            'I_fast_ib1_decay','Ifast_deconv_ib1_decay' ]].copy()
...
df2c = df2[['Sim','Team', 'iB0', 'iB1', 'iB2', 'ENSCI', 'Sol', 'ADX','Buf','PO3','PO3_OPM', 'Tsim','Pair',
            ...
            'Ifast_minib0_deconv', 'Ifast_minib0_deconv_ib1_decay','Ifast_minib0', 'Ifast_minib0_ib1_decay',
            'Islow_conv','Ifast_deconv_ib1_decay','I_fast_ib1_decay','Ifast_deconv_ib1_decay']].copy()

df_0910_final = pd.concat([df1c, df2c], ignore_index=True)
df_0910_final.to_csv('/home/poyraden/Analysis/JOSIEfiles/Proccessed/Josie0910_deconv_2023_unitedpaper_HVbeta.csv')